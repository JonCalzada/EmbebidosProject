...
# Asegúrate de que el archivo ultrasonico.py esté en el mismo directorio que este script
...
class ScreenTwo(Screen):
    ...
    def start_checking_alarm(self):
        if self.check_alarm_event is None:
            self.check_alarm_event = Clock.schedule_interval(self.check_alarm_status, 30)
    ...
    def check_alarm_status(self, dt):
        if medir():
            ...
            popup = Popup(title='Alerta',
                          content=Label(text='¡Asaltante detectado!'),
